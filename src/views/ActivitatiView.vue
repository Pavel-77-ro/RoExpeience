...
/**
 * Helper to resolve asset URLs at build‑time so they work with dynamic binding
 * Works with Vite / Vue CLI: new URL(relativePath, import.meta.url).href
 */
...
const categories = [
  {
    ...
    activities: [
      ...
      },
      {
        ...
        img: asset('activities/cooking.jpg'),
        desc: '“Cooking Hobby” – gătiți rețete locale & internaționale în bucătăria noastră complet echipată. Ingredientele, șorțul personalizat și degustarea finală sunt incluse.',
        details: [
          '6‑15 participanți • 2‑3 h',
          'Rețete de sezon & opțiuni vegetariene',
          'Diplomă de participare inclusă'
        ]
      },
      {
        title: 'Art & Craft',
        img: asset('activities/crafts.jpg'),
        desc: 'Ateliere creative pentru toate vârstele: pictură pe ceramică, figurine din lemn, ornamente de Crăciun sau tehnici tradiționale de vopsit ouă.',
        details: [
          '8‑20 participanți • 1,5‑2 h',
          'Materiale incluse',
      ...
      },
      {
        ...
        img: asset('activities/movie_night.jpg'),
        desc: 'Proiecţii pe ecran de 5 m cu sistem audio profesional sub cerul liber. Filme, documentare sau meciuri, la alegere.',
        details: [
          'Max. 50 persoane',
      ...
      {
        title: 'Foc de Tabără & Story‑telling',
        img: asset('activities/campfire.jpg'),
      ...
      },
      {
        ...
        img: asset('activities/pavilion.jpg'),
        desc: 'Pavilion acoperit pentru yoga matinală, workshopuri în aer liber sau coffee‑break relaxat.',
        details: [
  ...
  },
  {
    ...
    activities: [
      ...
      {
        title: 'Ture e‑Bike',
        img: asset('activities/ebike.jpg'),
